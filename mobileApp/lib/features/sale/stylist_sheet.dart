...
class _StylistSheetState extends State<_StylistSheet> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<StylistController>().loadIfNeeded();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final stylists = context.watch<StylistController>();
  ...
  Widget _content(AstraPalette p, StylistController stylists, List<Employee> list, Employee? me) {
