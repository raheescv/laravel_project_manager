...
class _NewSaleScreenState extends State<NewSaleScreen> {
  ...
  Widget build(BuildContext context) {
    final cat = context.watch<CatalogController>();
  ...
  Widget _tabletCartPanel(CartController cart) {
  ...
  Widget _categoryChips(CatalogController cat) {
    return SizedBox(
      height: 38,
      child: ListView(
  ...
  Future<void> _scanBarcode(CatalogController cat) async {
