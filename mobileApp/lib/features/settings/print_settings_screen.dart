...
class PrintSettingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final c = context.watch<PrintSettingsController>();
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    _segment<PrintStyle>(
                      ...
                      selected: c.style,
                      labelOf: (s) => s.label,
                      onSelect: (s) => context.read<PrintSettingsController>().setStyle(s),
                    ),
                    Padding(
                    ...
                    _segment<PaperWidth>(
                      ...
                      selected: c.width,
                      labelOf: (w) => w.label,
                      onSelect: (w) => context.read<PrintSettingsController>().setWidth(w),
                    ),
                    const SizedBox(height: 20),
                    ...
                    _toggle(
                      ...
                      onChanged: (v) => context.read<PrintSettingsController>().setShowDiscount(v),
                    ),
                    ...
                    _toggle(
                      ...
                      onChanged: (v) => context.read<PrintSettingsController>().setShowTotalQty(v),
                    ),
                    const SizedBox(height: 9),
                    _toggle(
                      context,
                      ...
                      value: c.showBarcode,
                      onChanged: (v) => context.read<PrintSettingsController>().setShowBarcode(v),
                    ),
                  ],
                ),
              ),
