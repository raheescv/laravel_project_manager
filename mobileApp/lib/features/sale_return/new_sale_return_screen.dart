...
class NewSaleReturnScreen extends StatelessWidget {
  ...
  Widget _note(BuildContext context, ReturnDraftController draft) {
  ...
  Widget _lineCard(BuildContext context, ReturnDraftController draft, ReturnLine line) {
    final p = context.astra;
  ...
  Widget _refundBar(BuildContext context, ReturnDraftController draft) {
    final p = context.astra;
