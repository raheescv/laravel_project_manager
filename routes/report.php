...
Route::middleware('auth')->group(function (): void {
    Route::name('log::')->prefix('log')
        ->controller(LogController::class)->group(function (): void {
            ...
            Route::get('emails', 'emails')->name('emails')->can('log.email');
        });
    ...
    Route::name('report::')->prefix('report')
        ->controller(ReportController::class)->group(function (): void {
            ...
            Route::get('sale_category', 'sale_category')->name('sale_category')->can('report.sale category');
            Route::get('sale_feedback', 'sale_feedback')->name('sale_feedback')->can('report.sale feedback');
            ...
            Route::get('profit_loss_statement', 'profit_loss_statement')->name('profit_loss_statement')->can('report.profit loss statement');
