...
use App\Actions\Settings\Complaint\DeleteAction;
...
class Table extends Component
{
    ...
    protected $listeners = [
        'Complaint-Refresh-Component' => '$refresh',
    ];
    ...
    {
        if ($value) {
            $this->selected = Complaint::latest()->limit(2000)->pluck('id')->toArray();
        } else {
            $this->selected = [];
        }
    }
    ...
    public function render()
    {
        ...
        return view('livewire.settings.complaint.table', [
            'data' => $data,
        ]);
    }
}
