...
class BookingTable extends Component
{
    ...
    protected $listeners = [
        'RentOutSaleBooking-Refresh-Component' => '$refresh',
    ];
    ...
    {
        if ($value) {
            $this->selected = RentOut::lease()->booked()->latest()->limit(2000)->pluck('id')->toArray();
        } else {
            $this->selected = [];
        }
    }
    ...
    public function render()
    {
        ...
        return view('livewire.rent-out.sale.booking-table', [
            'data' => $data,
        ]);
    }
}
