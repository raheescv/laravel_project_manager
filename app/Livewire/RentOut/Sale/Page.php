...
class Page extends Component
{
    ...
    public function loadData()
    {
        if ($this->table_id) {
            ...
            if (! $item) {
                ...
                return redirect()->route('property::sale::index');
            }
    ...
    public function confirm()
    {
        try {
            ...
            return redirect()->route('property::sale::view', $this->table_id);
        } catch (\Exception $e) {
            DB::rollback();
    ...
    public function save()
    {
        try {
            ...
            if ($this->type === 'Booking') {
                return redirect()->route('property::sale::booking.create', $this->table_id);
            }

            return redirect()->route('property::sale::create', $this->table_id);
        } catch (\Exception $e) {
            DB::rollback();
            $this->dispatch('error', ['message' => $e->getMessage()]);
        }
    ...
    {
        return view('livewire.rent-out.sale.page');
    }
}
