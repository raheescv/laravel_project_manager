...
class BookingTable extends Component
{
    ...
    protected $listeners = [
        'RentOutRentBooking-Refresh-Component' => '$refresh',
    ];
    ...
    {
        if ($value) {
            $this->selected = RentOut::rental()->booked()->latest()->limit(2000)->pluck('id')->toArray();
        } else {
            $this->selected = [];
        }
    }
    ...
    public function render()
    {
        ...
        return view('livewire.rent-out.rent.booking-table', [
            'data' => $data,
        ]);
    }
}
