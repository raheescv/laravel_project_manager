...
class Page extends Component
{
    ...
    /** Last few income accounts used on this tenant, as [['id' => …, 'name' => …]] — one-tap chips under the category. */
    ...
    {
        abort_unless(auth()->user()?->can($this->table_id ? 'income.edit' : 'income.create'), 403);
        $this->validate();
        try {
            DB::beginTransaction();
            $userId = Auth::id();
