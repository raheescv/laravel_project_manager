    ...
    protected function getBaseQuery()
{
    return Sale::with('branch')
        ...
        ->where('sales.type', 'booking') // always booking
        ...
        ->when($this->created_by, fn($q) => $q->where('sales.created_by', $this->created_by))
        ->when($this->payment_method_id, fn($q) => $q->where('sales.payment_method_id', $this->payment_method_id))
    ...
    public function render()
    {
        ...
        // info(DB::getQueryLog());
        return view('livewire.sale.bookingtable', [
            'total' => $total,
