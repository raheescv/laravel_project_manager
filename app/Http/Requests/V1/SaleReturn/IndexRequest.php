...
class IndexRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sort_by' => ['nullable', 'string', 'in:date,reference_no,paid,grand_total,total,id'],
    ...
    {
        return [
            'status.in' => 'The status must be one of: draft, completed.',
            'sort_by.in' => 'The sort by field must be one of: date, reference_no, paid, grand_total, total, id.',
