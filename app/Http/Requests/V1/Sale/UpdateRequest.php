...
class UpdateRequest extends FormRequest
{
     ...
     *
     * Mirrors Sale\StoreRequest, but every line may carry an `id` (the existing
     * sale_item id). Lines with an id update that row; lines without one are added.
     * Any existing line whose id is absent from the payload is removed.
     *
