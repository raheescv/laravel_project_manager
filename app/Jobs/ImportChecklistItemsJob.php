...
use App\Imports\ChecklistItemImport;
...
class ImportChecklistItemsJob implements ShouldQueue
{
    ...
    private function runImport(): void
    {
        ...
        Excel::import(new ChecklistItemImport(
            $this->userId,
            $totalRows,
            $this->tenantId,
            $this->mappings,
    ...
    public function failed(\Throwable $exception): void
    {
        ...
        Notification::send($user, new ImportErrorsNotification('Checklist Item', '', $errors));

        event(new FileImportProgress($this->userId, 'ChecklistItem', -1, $exception->getMessage()));
    }
}
