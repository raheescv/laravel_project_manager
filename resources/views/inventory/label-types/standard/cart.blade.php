...
<head>
    ...
    {{-- Always embedded: a cart print only ever goes to the PDF renderer, which
         cannot fetch anything. --}}
    {!! BarcodeFonts::styleTag($settings) !!}
    <style>
        @page {
            margin: 0;
            padding: 0;
        ...
        .barcode-value {
            ...
            margin-top: 2px;
            font-family: {!! BarcodeFonts::elementStack($settings, 'barcode') !!};
            font-weight: {{ BarcodeFonts::elementWeight($settings, 'barcode', 400) }};
            line-height: 1;
        }
