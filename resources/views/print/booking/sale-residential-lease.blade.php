...
@php
    ...
    if ($residentialLogoLease) {
        ...
        if (file_exists($residentialLogoLeasePath)) {
            $residentialLogoLeaseUrl =
                'data:image/' .
                pathinfo($residentialLogoLeasePath, PATHINFO_EXTENSION) .
                ';base64,' .
                base64_encode(file_get_contents($residentialLogoLeasePath));
        }
    }
                    ...
                    <div class="container">
                        ...
                        <div id="header_container" style="display: flex; align-items: flex-start; gap: 20px;">
                            ...
                            <div style="text-align: center; flex-shrink: 0;" id='qr_code_container'>
                                <div
                                    style="margin-bottom: 1px; display: inline-block; padding: 1px; box-shadow: 0 4px 8px rgba(0,0,0,0.2); background: white; border-radius: 4px; position: relative; z-index: 99999999; isolation: isolate; mix-blend-mode: normal;">
                                    <img style="width: 60px; height: 50px;"
                                        src="data:image/png;base64,{{ DNS2D::getBarcodePNG(url('property/sale/booking/view/' . $rentOut->id), 'QRCODE', 5, 5) }}"
                                        alt="QR Code">
                                    <br>
                        ...
                        <div class="section">
                            <div class="row">
                                <div class="cell cell-en">
                                    ...
                                    <p>
                                        The first party owns the piece of land located in the registered area with the property details as described
                                        above. The first party has started obtaining permits
                                        for the construction of the project, according to the approved drawings and engineering specifications by the
                                ...
                                <div class="cell cell-ar">
                                    ...
                                    <p>
                                        يملك الطرف الأول قطعة الأرض الواقعة في المنطقة المسجلة بتفاصيل الملكية كما هو موضح أعلاه. وقد بدأ الطرف الأول
                                        في الحصول على التصاريح لبناء المشروع، وفقاً للرسومات والمواصفات الهندسية المعتمدة من الجهات المختصة.
                                    </p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="cell cell-en">
                                    <p>
                                        The second party has confirmed the will to purchase a residential unit in this project, and according to the
                                        provisions
                                        of this contract and the price mentioned therein, the two parties have agreed to draft this contract under the
                                        following legal and lawful conditions:
                                    </p>
                                </div>
                                <div class="cell cell-ar">
                                    <p>
                                        وقد أكد الطرف الثاني رغبته في شراء وحدة سكنية في هذا المشروع، ووفقاً لأحكام هذا العقد والسعر المذكور فيه، فقد
                                        اتفق الطرفان على صياغة هذا العقد بالشروط القانونية والنظامية التالية:
                                    </p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="cell cell-en">
                                    <p>
                                        Unit No. :<b>Unit ({{ $rentOut->property?->number }}) – {{ $rentOut->property?->floor }} Floor –
                                            {{ $rentOut->type?->name }} Apartment </b>
                                        <br>
                                        The area of this unit on the map and the architectural drawing of the project
                                        (<b>{{ $rentOut->property?->size }} square meters</b>) is subject to
                                        deficit and surplus, and the common facilities in the tower will be added, which are the common areas of the
                                        apartment as specified in the (Terms and Conditions of Apartment Sale).
                                    </p>
                                </div>
                                <div class="cell cell-ar">
                                    <p>
                                        رقم الوحدة: <b>الوحدة ({{ $rentOut->property?->number }}) – الطابق {{ $rentOut->property?->floor }} – شقة
                                            {{ $rentOut->type?->name }}</b>
                                        <br>
                                        مساحة هذه الوحدة على الخريطة والرسم المعماري للمشروع (<b>{{ $rentOut->property?->size }} متر مربع</b>) تخضع
                                        للنقص والزيادة، وسيتم إضافة المرافق المشتركة في البرج، وهي المناطق المشتركة للشقة كما هو محدد في (شروط وأحكام
                                        بيع الشقة).
                                    </p>
                                </div>
                            </div>
                            ...
                            <table style="width: 100%; border-collapse: collapse; border: 2px solid #000; margin-bottom: 120px;">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($installments as $item)
                                        ...
                                        <tr style="{{ $trStyle }}">
                                            ...
                                            <td style="border: 1px solid #000; padding: 2px; text-align: right;">
                                                {{ getPercentage($item->total ?? $item->amount, $rentOut->rent, 2, true) }}</td>
                                            <td style="border: 1px solid #000; padding: 2px; text-align: center;">{{ systemDate($item->due_date) }}
                                            </td>
                                            <td style="border: 1px solid #000; padding: 2px; text-align: right;">
                                                {{ currency($item->total ?? $item->amount) }}</td>
                                        </tr>
                                    @endforeach
                                    @php
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: 1px solid #000; padding: 2px; text-align: right;">
                                            {{ getPercentage($total, $rentOut->rent, 2, true) }}</td>
                                    ...
                                    @if ($balance > 0)
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #000; padding: 2px; text-align: right;">
                                                {{ getPercentage($balance, $rentOut->rent, 2, true) }}</td>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <table style="width: 100%; border-collapse: collapse; border: 2px solid #000;">
                                            <tr>
                                                <td
                                                    style="border: 1px solid #000; padding: 15px; width: 50%; text-align: left; vertical-align: top;">
                                                    <strong>Qatari Riyal Only</strong><br>
                                                    <span style="font-size: 10px;">ريال قطري فقط</span>
                                                </td>
                                                <td
                                                    style="border: 1px solid #000; padding: 15px; width: 25%; text-align: center; vertical-align: top;">
                                            ...
                                            <tr>
                                                <td
                                                    style="border: 1px solid #000; padding: 30px; height: 80px; text-align: center; text-transform: capitalize;">
                                                    {{ $numberToWord['english'] }} <br>
                                                    {{ $numberToWord['arabic'] }}
                                                </td>
                                                <td style="border: 1px solid #000; padding: 30px; height: 80px; text-align: center;">
                                                    {{ currency($rentOut->rent) }}</td>
                        ...
                        <div class="section">
                            <div class="row">
                                <div class="cell cell-en">
                                    ...
                                    <p>The preliminary section is considered an integral part of this contract and is complement to its provisions, in
                                        addition to the approved plans and architecture drawings from the relevant authorities, as well as the
                                        appendixes accompanying this contract.</p>
                                </div>
                                <div class="cell cell-ar">
                                    <div class="section-title">المادة الأولى</div>
                                    <p>يعتبر الجزء التمهيدي جزء لا يتجزأ من هذا العقد متمماً له ولبنوده – اضافة الى المخططات والرسومات الهندسية
                                        المعتمدة من الجهات المختصة والملاحق المرفقة لهذا العقد.</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="cell cell-en">
                                    <div class="section-title">Article Two</div>
                                    <p>The first party has sold, transferred, and relinquished with all legal and actual warranties to the second
                                        party, a specified-bounded unit described in the sales map (off plan sale) for the project. The unit is
                                        complete with doors, windows, outlets, and services such as water, lighting, sewage, and gas, with a fully
                                        furnished finishing system.<br><br>The area of the property sold is approximately
                                        ({{ $rentOut->property?->size }} sqm) square meters, subject to deficiency and excess based on engineering
                                        and architectural design.</p>
                                </div>
                                <div class="cell cell-ar">
                                    <div class="section-title">المادة الثانية</div>
                                    <p>باع وأسقط وتنازل الطرف الأول بكافة الضمانات القانونية والفعلية للطرف الثاني القابل لذلك ما هو عبارة عن الوحدة
                                        محددة الحدود مع الأوصاف بنظام البيع على الخارطة في المشروع. مستكملة الأبواب والنوافذ والمنافذ والخدمات من مياه
                                        وإنارة وصرف صحي وغاز بنظام تشطيب كامل مفروش.<br><br>ومساحة العقار الذي يقع للوحد المباعة
                                        ({{ $rentOut->property?->size }} متر مربع) متر مربع تقريباً تحت العجز والزيادة.</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="cell cell-en">
                                    <div class="section-title">Article Three</div>
                                    <p>This sale has been finalized for a total amount of ({{ currency($rentOut->rent) }}) Qatari Riyals only. The
                                        second party has made a payment following the specified installment plan, as agreed between both parties in
                                        this contract.</p>
                                </div>
                                <div class="cell cell-ar">
                                    <div class="section-title">المادة الثالثة</div>
                                    <p>تم هذا البيع نظير مبلغ اجمالي وقدره ({{ currency($rentOut->rent) }}) – فقط ريال قطري لا غير وقد قام الطرف
                                        الثاني بدفع المبلغ ثمن الوحدة وبالنظام المحدد بطريقة أقساط.</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="cell cell-en">
                                    <div class="section-title">Article Four</div>
                                    <p>The first party acknowledges that the ownership of the land on which the project is established has been
                                        transferred to the property developer through purchase. Both parties are aware that the ownership of the
                                        second party for the sold unit, after its completion and handover, is subject to the provisions of real estate
                                        ownership stipulated by civil law.</p>
                                </div>
                                <div class="cell cell-ar">
                                    <div class="section-title">المادة الرابعة</div>
                                    <p>يقر الطرف الأول بأن ملكية الأرض المقام عليها المشروع قد آلت إليه عن طريق الشراء كما أنه من المعلوم للطرفين أن
                                        تملك الطرف الثاني للوحدة المباعة بعد استلامها بعد اتمام المشروع يخضع لأحكام ملكية الطبقات المنصوص عليها
                                        بالقانون المدني.</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="cell cell-en">
                                    ...
                                    <p>The buyer acknowledges, agrees, and understands that they are obligated to directly pay service fees/charges to
                                        the seller or the company managing the tower. The buyer agrees and undertakes to comply with the provisions of
                                        the management agreement and community rules.</p>
                                </div>
                                <div class="cell cell-ar">
                                    <div class="section-title">المادة الخامسة</div>
                                    <p>يقر المشتري ويوافق ويفهم أنه ملزم بدفع رسوم الخدمة مباشرة للبائع أو الشركة التي ستدير البرج. يوافق المشتري
                                        ويتعهد بالامتثال لأحكام اتفاقية الإدارة وقواعد المجتمع.</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="cell cell-en">
                                    <div class="section-title">Article Six</div>
                                    <p>The second party, the buyer, acknowledges that they have examined the approved plans and drawings of the
                                        project during its construction phase. The buyer accepts the unit in its current condition, under the
                                        agreed-upon terms.</p>
                                </div>
                                <div class="cell cell-ar">
                                    <div class="section-title">المادة السادسة</div>
                                    <p>يقر الطرف الثاني – المشتري – بأنه قد عاين المخططات والرسومات الهندسية المعتمدة قيد التشييد وبناء المشروع وقبلها
                                        على حالتها وبالشروط المتفق عليها.</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="cell cell-en">
                                    <div class="section-title">Article Seven</div>
                                    <p>The first party affirms to the second party that the sold unit is free from all real property rights,
                                        regardless of their type or nature.</p>
                                </div>
                                <div class="cell cell-ar">
                            ...
                            <div class="row">
                                <div class="cell cell-en">
                                    ...
                                    <p>The second party acknowledges that they are prohibited from engaging in any activities that could compromise
                                        the common usufruct or harm other property owners or occupants.</p>
                                </div>
                                <div class="cell cell-ar">
                                    <div class="section-title">المادة الثامنة</div>
                                    <p>يقر الطرف الثاني بأنه ممنوع من القيام بأي من الأعمال من شأنها أن تخل بالإنتفاع المشترك أو تضر بباقي الملاك أو
                                        شاغليه.</p>
                                </div>
                            </div>
                        </div>
                        <div class="section">
                            <div class="row">
                                <div class="cell cell-en">
                                    ...
                                    <p>The first party undertakes to initiate the registration procedures of the segregated unit according to the
                                        provisions of the Real Estate Registration Law.</p>
                                </div>
                                <div class="cell cell-ar">
                            ...
                            <div class="row">
                                <div class="cell cell-en">
                                    ...
                                    <p>The parties to this contract agree that in the event of a breach of any obligations by either party arising
                                        from this contract, the defaulting party shall be obligated to pay the other party a compensation as agreed
                                        upon.</p>
                                </div>
                                <div class="cell cell-ar">
                                    <div class="section-title">المادة الحادي عشر</div>
                                    <p>اتفق أطراف هذا العقد بأنه في حال اخلال أي طرف لأي من التزاماته الناشئة عن هذا العقد يكون ملزماً بدفع تعويض متفق
                                        عليه.</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="cell cell-en">
                                    ...
                                    <p>The second party undertakes to bear all expenses, fees, and charges related to the demarcation and survey of
                                        their unit.</p>
                                </div>
                                <div class="cell cell-ar">
                            ...
                            <div class="row">
                                <div class="cell cell-en">
                                    ...
                                    <p>In the event of the buyer taking action on the unit, the buyer commits to paying 2% of the resale value to the
                                        seller as administrative fees.</p>
                                </div>
                                <div class="cell cell-ar">
                            ...
                            <div class="row">
                                <div class="cell cell-en">
                                    ...
                                    <p>The prementioned addresses in this contract shall be considered as the valid addresses for notifications,
                                        correspondence, and any potential disputes.</p>
                                </div>
                                <div class="cell cell-ar">
                            ...
                            <div class="row">
                                <div class="cell cell-en">
                                    ...
                                    <p>The appendices attached to this contract are integral to it, and they constitute an inseparable part of its
