                ...
                <ul class="mainnav__menu nav flex-column">
                    ...
                    @can('property lead.view')
                        <li class="nav-item has-sub">
                            ...
                            <a href="#" class="mininav-toggle nav-link {{ request()->is($leadList) ? 'active' : '' }}">
                                ...
                                <span class="nav-label mininav-content ms-1 collapse show" style="">Leads</span>
                            </a>
                            <ul class="mininav-content nav collapse">
                                <li data-popper-arrow class="arrow"></li>
                                <li class="nav-item">
                    ...
                    @if (auth()->user()->can('maintenance.view') ||
                        ...
                        <li class="nav-item has-sub">
                            ...
                            @endphp
                            <a href="#" class="mininav-toggle nav-link {{ request()->is($maintenanceList) ? 'active' : '' }}"><i
                                    class="fa fa-wrench fs-5 me-2"></i>
                                <span class="nav-label mininav-content ms-1 collapse show" style="">Maintenance</span>
                            </a>
                            <ul class="mininav-content nav collapse">
                                <li data-popper-arrow class="arrow"></li>
                        ...
                        <li class="nav-item has-sub">
                            ...
                            <ul class="mininav-content nav collapse">
                                ...
                                @can('report.sale return item')
                                    {{-- <li class="nav-item">
                                        <a href="{{ route('report::sale_return_item') }}" class="nav-link {{ request()->is(['report/sale_return_item']) ? 'active' : '' }}">Return Item Wise Report</a>
                                    </li> --}}
                                @endcan
                    ...
                    @if (auth()->user()->can('purchase request.view') || auth()->user()->can('local purchase order.view') || auth()->user()->can('grn.view') || auth()->user()->can('lpo-purchase.view'))
                        <li class="nav-item has-sub">
                            <a href="#"
                                class="mininav-toggle nav-link {{ request()->routeIs(['purchase-request::*', 'lpo::*', 'grn::*', 'lpo-purchase::*', 'purchase-vendor::*']) ? 'active' : '' }}"><i
