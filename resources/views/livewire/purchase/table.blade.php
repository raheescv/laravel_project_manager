            ...
            <div class="col-md-6 d-flex gap-1 align-items-center justify-content-md-end mb-3">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" style="position: absolute; inset: auto 0px 0px auto; margin: 0px; transform: translate3d(-0.5px, -40px, 0px);"
                        ...
                        <li><a class="dropdown-item" data-bs-toggle="offcanvas" data-bs-target="#purchaseColumnVisibility" aria-controls="purchaseColumnVisibility">Column Visibility</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="row">
                ...
                <div class="col-md-6" wire:ignore>
                    <b><label for="vendor_id">Customer</label></b>
                    {{ html()->select('vendor_id', [])->value('')->class('select-vendor_id-list')->id('vendor_id')->placeholder('All') }}
                </div>
            </div>
            <div class="row my-2">
                ...
                <div class="col-md-3" wire:ignore>
                    ...
                    {{ html()->select('status', purchaseStatuses())->value($status)->class('tomSelect')->id('status')->placeholder('All') }}
                </div>
            </div>
        </div>
    </div>
                ...
                <tbody>
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td><a href="{{ route('purchase::edit', $item->id) }}">{{ $item->invoice_no }} </a></td>
                            @if ($purchase_visible_column['branch_id'])
