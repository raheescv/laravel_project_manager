<div>
    <div class="card shadow-sm">
        <div class="card-header bg-light py-3">
            <div class="row mt-3">
                <div class="col-md-6 d-flex flex-wrap gap-2 align-items-center mb-3 mb-md-0">
                    @can('property group.create')
                        <button class="btn btn-primary d-flex align-items-center shadow-sm" id="PropertyGroupAdd">
                            <i class="fa fa-plus-circle me-2"></i>
                            Add New Group
                        </button>
                    @endcan
                    <div class="btn-group shadow-sm">
                        @can('property group.delete')
                    ...
                    <div class="row g-2 align-items-center">
                        ...
                        <div class="col">
                            <div class="input-group input-group-sm">
                                ...
                                <input type="text" wire:model.live="search" autofocus placeholder="Search property groups..." class="form-control form-control-sm border-secondary-subtle shadow-sm"
                                    autocomplete="off">
                            </div>
                        </div>
                    </div>
                ...
                <table class="table table-hover align-middle border-bottom mb-0 table-sm">
                    <thead class="bg-light text-muted">
                        <tr class="text-capitalize small">
                            ...
                            <th class="fw-semibold">Lease Agreement Year</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="fw-medium text-dark">
                                        <i class="fa fa-object-group me-1 text-primary opacity-75"></i>{{ $item->name }}
                                    </span>
                                </td>
                                <td>
                                    @if($item->arabic_name)
                                ...
                                <td>
                                    @if($item->lease_agreement_years)
                                        <i class="fa fa-calendar me-1 text-muted"></i>{{ $item->lease_agreement_years }}
                                    @else
                                        -
                                    @endif
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center py-5 text-muted">
                                    <i class="fa fa-object-group fa-3x mb-3 d-block opacity-25"></i>
                                    No property groups found matching your search.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
        ...
        <div class="position-fixed bottom-0 end-0 mb-4 me-4 d-md-none">
            <button id="PropertyGroupAddMobile" class="btn btn-primary rounded-circle shadow btn-lg">
            ...
            <script>
                $(document).ready(function() {
                    ...
                    $(document).on('click', '.edit', function() {
                        Livewire.dispatch("PropertyGroup-Page-Update-Component", {
                            id: $(this).attr('table_id')
                        });
                    });
                    $('#PropertyGroupAdd, #PropertyGroupAddMobile').click(function() {
                        Livewire.dispatch("PropertyGroup-Page-Create-Component");
                    });
                    window.addEventListener('RefreshPropertyGroupTable', event => {
                        Livewire.dispatch("PropertyGroup-Refresh-Component");
                    });
                });
            </script>
        @endpush
