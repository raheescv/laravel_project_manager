            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 small">
                        <li class="breadcrumb-item"><a href="{{ route('property::sale::index') }}"><i class="fa fa-home"></i></a></li>
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                @can('rent out lease.edit')
                    @if($rentOut->status?->value === 'booked')
                        <a href="{{ route('property::sale::booking.create', $rentOut->id) }}" class="btn btn-sm btn-outline-primary">
                            <i class="fa fa-pencil me-1"></i> Edit
                        </a>
                    @else
                        <a href="{{ route('property::sale::create', $rentOut->id) }}" class="btn btn-sm btn-outline-primary">
                            <i class="fa fa-pencil me-1"></i> Edit
                        </a>
                    @endif
                @endcan
                ...
                <div class="card border-0 shadow-sm h-100">
                    ...
                    <div class="card-body p-0">
                        <div class="list-group list-group-flush">
                            ...
                            <div class="list-group-item py-2 px-3">
                                <div class="row align-items-center">
                                    <div class="col-5 fw-semibold small">Agreement Type:</div>
                                    <div class="col-7 small">{{ $rentOut->agreement_type?->label() }}</div>
                                </div>
                            </div>
                            <div class="list-group-item py-2 px-3">
                                <div class="row align-items-center">
                            ...
                            <div class="list-group-item py-2 px-3">
                                <div class="row align-items-center">
                                    <div class="col-5 fw-semibold small">Sale Price:</div>
                        ...
                        <div class="bg-light border-top p-3">
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm table-striped mb-0" style="font-size: 0.8rem;">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="py-1 px-2 fw-semibold">Sale</td>
