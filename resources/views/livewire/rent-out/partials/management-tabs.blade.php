    ...
    <div class="card-body p-0">
        ...
        <ul class="nav nav-tabs border-bottom px-2 pt-2" id="managementTabs" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link" :class="activeTab === 'PaymentTab' ? 'active' : ''"
                    @click="activeTab = 'PaymentTab'" type="button">
                    <i class="fa fa-credit-card me-1"></i>
                    <span class="small">Payment</span>
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" :class="activeTab === 'PaymentTermTab' ? 'active' : ''"
                    @click="activeTab = 'PaymentTermTab'" type="button">
            ...
            @if ($isRental)
                <li class="nav-item" role="presentation">
                    <button class="nav-link" :class="activeTab === 'UtilitiesTab' ? 'active' : ''"
                        @click="activeTab = 'UtilitiesTab'" type="button">
            ...
            @endif
            <li class="nav-item" role="presentation">
                <button class="nav-link" :class="activeTab === 'ServicesTab' ? 'active' : ''"
                    @click="activeTab = 'ServicesTab'" type="button">
                    <i class="fa fa-cogs me-1"></i>
                    <span class="small">Services</span>
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" :class="activeTab === 'ChequeTab' ? 'active' : ''"
                    @click="activeTab = 'ChequeTab'" type="button">
                    <i class="fa fa-check-square-o me-1"></i>
                    <span class="small">Cheques</span>
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" :class="activeTab === 'SecurityTab' ? 'active' : ''"
                    @click="activeTab = 'SecurityTab'" type="button">
                    <i class="fa fa-shield me-1"></i>
                    <span class="small">Security</span>
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" :class="activeTab === 'ExtendTab' ? 'active' : ''"
                    @click="activeTab = 'ExtendTab'" type="button">
                    <i class="fa fa-plus-circle me-1"></i>
                    <span class="small">Extend</span>
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" :class="activeTab === 'NotesTab' ? 'active' : ''"
                    @click="activeTab = 'NotesTab'" type="button">
                    <i class="fa fa-file-text-o me-1"></i>
                    <span class="small">Notes</span>
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" :class="activeTab === 'TransactionTab' ? 'active' : ''"
                    @click="activeTab = 'TransactionTab'" type="button">
                    <i class="fa fa-exchange me-1"></i>
                    <span class="small">Transactions</span>
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" :class="activeTab === 'MaintenanceTab' ? 'active' : ''"
                    @click="activeTab = 'MaintenanceTab'" type="button">
                    <i class="fa fa-wrench me-1"></i>
                    <span class="small">Maintenance</span>
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" :class="activeTab === 'DocumentsTab' ? 'active' : ''"
                    @click="activeTab = 'DocumentsTab'" type="button">
