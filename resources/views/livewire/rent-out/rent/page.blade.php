<div>
    <form wire:submit="save">
            ...
            <div class="card-body py-4">
                <div class="row g-3">
                    <div class="col-md-3" wire:ignore>
                        ...
                        <select class="form-select select-property_group_id" id="property_group_id">
                    ...
                    <div class="col-md-3" wire:ignore>
                        ...
                        <select class="form-select select-property_building_id" id="property_building_id">
                    ...
                    <div class="col-md-3" wire:ignore>
                        ...
                        <select class="form-select select-property_type_id" id="property_type_id">
                    ...
                    <div class="col-md-3" wire:ignore>
                        ...
                        <select class="form-select select-property_id" id="property_id">
                    ...
                    <div class="col-md-6" wire:ignore>
                        ...
                        <select class="form-select select-account_id" id="account_id">
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-header bg-white py-3 border-bottom">
                <div class="d-flex align-items-center">
                    <i class="demo-psi-coins fs-4 me-2 text-warning"></i>
            ...
            <div class="card-body py-4">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        <label class="form-label fw-semibold small"><i class="demo-psi-coins text-warning me-1"></i> Rent</label>
                        <input type="number" class="form-control" id="rent" wire:model.live="rentouts.rent" step="0.01">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label fw-semibold small"><i class="demo-psi-calculator text-success me-1"></i> Total Amount</label>
            ...
            <div class="card-body py-4">
                <div class="row g-3">
                    <div class="col-md-3" wire:ignore>
                        ...
                        <select class="form-select select-salesman_id" id="salesman_id">
                    ...
                    <div class="col-md-3">
                        <label class="form-label fw-semibold small"><i class="demo-psi-bookmark text-warning me-1"></i> Booking Type *</label>
                    ...
                    <div class="col-md-6">
                        <label class="form-label fw-semibold small"><i class="demo-psi-check text-success me-1"></i> Included Amenities</label>
                        <div class="row g-2">
                            <div class="col-md-4">
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text bg-warning bg-opacity-10 border-warning border-opacity-25"><i class="demo-psi-flash text-warning"></i></span>
                            ...
                            <div class="col-md-4">
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text bg-info bg-opacity-10 border-info border-opacity-25"><i class="demo-psi-snowflake text-info"></i></span>
                            ...
                            <div class="col-md-4">
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text bg-success bg-opacity-10 border-success border-opacity-25"><i class="demo-psi-wifi text-success"></i></span>
