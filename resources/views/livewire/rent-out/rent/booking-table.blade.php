    ...
    <div class="card-header bg-white py-3">
        <div class="row g-3 align-items-center">
            <div class="col-12 col-md-6 d-flex gap-2">
                @can('rent out.create')
                    <a href="{{ route('property::rent::booking.create') }}" class="btn btn-primary d-inline-flex align-items-center gap-2">
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                    ...
                    <tr>
                        <th class="ps-4" width="80">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" wire:model.live="selectAll" id="bookingSelectAll">
                            </div>
                        </th>
                ...
                <tbody>
                    @forelse ($data as $item)
                        <tr>
                            ...
                            <td class="text-end pe-4">
                                @can('rent out.view')
                                    <a href="{{ route('property::rent::booking.view', $item->id) }}" class="btn btn-icon btn-sm btn-hover btn-light" title="View Booking">
                                        <i class="demo-psi-file fs-5 text-muted"></i>
                                    </a>
                                @endcan
                                @can('rent out.edit')
                                    <a href="{{ route('property::rent::booking.create', $item->id) }}" class="btn btn-icon btn-sm btn-hover btn-light" title="Edit Booking">
                    ...
                    @empty
                        <tr>
                            <td colspan="10" class="text-center py-5 text-muted">No rental bookings found matching your search.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
