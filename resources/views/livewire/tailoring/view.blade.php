<div>
    <div class="min-vh-100 bg-body-tertiary py-4">
        <div class="container-fluid px-3 px-lg-4">
            ...
            <div class="card shadow border-0 mb-3 bg-primary-subtle">
                <div class="card-body">
                            ...
                            <div class="card-body" wire:key="category-content-{{ $activeCategoryTab }}">
                                ...
                                <div class="d-flex flex-column gap-3">
                                        ...
                                        <div class="card bg-primary-subtle border-0">
                                            <div class="card-body">
                                                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
                                                    <h3 class="h6 mb-0"><i class="fa fa-ruler me-1"></i>Measurements (Common Values)</h3>
                                    ...
                                    @foreach ($measurementData['items'] as $item)
                                        ...
                                        @endphp
                                        <div class="card border-0 shadow-sm border-start border-4 border-primary-subtle">
                                            <div class="card-body">
