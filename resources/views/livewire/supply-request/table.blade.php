            ...
            <div class="row g-3">
                <div class="col-md-4 d-flex flex-wrap gap-2 align-items-center">
                    @can('supply request.create')
                        <a href="{{ route($type === 'Return' ? 'supply-return::create' : 'supply-request::create') }}" class="btn btn-primary btn-sm hstack gap-2 shadow-sm">
                ...
                <div class="col-md-8">
                    <div class="gap-2 d-flex justify-content-md-end align-items-center">
                        ...
                        <div class="btn-group shadow-sm">
                            <button type="button" class="btn btn-light btn-sm dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false" title="Column Visibility">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" style="min-width: 200px;" onclick="event.stopPropagation()">
                                ...
                                <li><hr class="dropdown-divider"></li>
                                <li>
                                    <button class="dropdown-item small text-center text-muted" wire:click="resetColumnVisibility" onclick="event.stopPropagation()">
            ...
            <div class="mt-3 col-12">
                <div class="p-3 rounded bg-light">
                    <div class="row g-3">
                        ...
                        <div class="col-md-3" wire:ignore>
                            <label class="form-label small" for="sr_property_type_id">
                                <i class="fa fa-tags me-1"></i> Property Type
                            </label>
                            {{ html()->select('property_type_id', [])->value($this->property_type_id)->class('select-property_type_id-list')->id('sr_property_type_id')->placeholder('All Types') }}
                        </div>
                        <div class="col-md-3" wire:ignore>
