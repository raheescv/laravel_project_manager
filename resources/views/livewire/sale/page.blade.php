                ...
                <form wire:submit="submit">
                    ...
                    <div class="row g-4 mb-4">
                            ...
                            <div class="card h-100 border">
                                <div class="card-body">
                                    <div class="mb-3" wire:ignore>
                                        <label for="account_id" class="form-label fw-semibold"><i class="fa fa-user me-2"></i>Customer</label>
                        ...
                        <div class="col-md-3">
                            @if ($sales['account_id'] == 3)
                                <div class="card h-100 border">
                                    <div class="card-body">
                                        <label for="customer_name" class="form-label fw-semibold"><i class="fa fa-address-card me-2"></i>Customer Details</label>
                        ...
                        <div class="col-md-3">
                            <div class="card h-100 border">
                                <div class="card-body">
                                    <label for="reference_no" class="form-label fw-semibold"><i class="fa fa-tag me-2"></i>Reference & Type</label>
                        ...
                        <div class="col-md-3">
                            <div class="card h-100 border">
                                <div class="card-body">
                                    <label class="form-label fw-semibold"><i class="fa fa-calendar me-2"></i>Dates</label>
                                    <div class="mb-3">
                                        {{ html()->date('date')->value('')->class('form-control')->attribute('wire:model', 'sales.date') }}
                                        <small class="text-muted"><i class="fa fa-shopping-cart me-1"></i>Sale Date</small>
                                    </div>
                                    <div>
                                        {{ html()->date('due_date')->value('')->class('form-control')->attribute('wire:model', 'sales.due_date') }}
                                        <small class="text-muted"><i class="fa fa-clock-o me-1"></i>Due Date</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="table table-hover align-middle table-striped">
                                    <thead class="bg-light">
                                        <tr>
                                            ...
                                            <th class="text-end"><i class="fa fa-cubes me-1"></i> Quantity</th>
                                            ...
                                            @if ($sales['other_discount'] > 0)
                                                <th class="text-end"><i class="fa fa-calculator me-1"></i> Effective Total</th>
                                            @endif
                                            <th><i class="fa fa-cogs me-1"></i> Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @php
                                    ...
                                    <tfoot class="table-group-divider">
                                        ...
                                        @endphp
                                        <tr class="fw-bold">
                                            <th colspan="3" class="text-end"><i class="fa fa-calculator me-1"></i> Total</th>
                    ...
                    <div class="row g-4">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-borderless">
                                            <tr>
                                                <th width="50%"><i class="fa fa-calculator me-1"></i> Gross Total</th>
                                                <td class="text-end">
                                                    {{ currency($sales['gross_amount']) }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <th><i class="fa fa-shopping-cart me-1"></i> Sale Total</th>
                                                <td class="text-end">
                                                    {{ currency($sales['total']) }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <th><i class="fa fa-tag me-1"></i> Other Discount</th>
                                                <td>
                                            ...
                                            <tr>
                                                <th><i class="fa fa-truck me-1"></i> Freight</th>
                                                <td>
                                    ...
                                    <div class="mt-3">
                                        <label for="address" class="form-label fw-semibold"><i class="fa fa-map-marker me-1"></i> Delivery Address</label>
                        ...
                        <div class="col-md-6">
                            <div class="card shadow-sm h-100">
                                <div class="card-header bg-light py-3">
                                    <h5 class="card-title mb-0"><i class="fa fa-credit-card me-2"></i>Payment Details</h5>
                                </div>
                                <div class="card-body">
                                    <div class="alert alert-info mb-4">
                                        <div class="text-center">
                                            <h4 class="alert-heading"><i class="fa fa-money me-2"></i>Total Payable Amount</h4>
                                    ...
                                    <table class="table table-hover">
                                        <thead class="table-light">
                                            <tr>
                                                <th><i class="fa fa-credit-card me-1"></i> Payment Method</th>
                                    ...
                                    @if ($this->getErrorBag()->count())
                                        <div class="alert alert-danger mt-3">
                                            <h5 class="mb-2"><i class="fa fa-exclamation-triangle me-1"></i> Validation Errors</h5>
                                            <ul class="mb-0">
                                                @foreach ($this->getErrorBag()->toArray() as $error)
                                                    <li><i class="fa fa-times-circle me-1"></i> {{ $error[0] }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    @endif
                                                ...
                                                <table class="table table-sm table-borderless">
                                                    <tbody class="text-muted">
                                                        @isset($sales['created_user']['name'])
                                                            <tr>
                                                                <td><i class="fa fa-user-plus me-1"></i> Created By:</td>
                                                                <td><strong>{{ $sales['created_user']['name'] }}</strong></td>
                                                            </tr>
                                                            <tr>
                                                                <td><i class="fa fa-pencil me-1"></i> Updated By:</td>
                                                                <td><strong>{{ $sales['updated_user']['name'] ?? '' }}</strong></td>
                                                            </tr>
                                                        @endisset
                                                        @isset($sales['cancelled_user']['name'])
                                                            <tr>
                                                                <td><i class="fa fa-ban me-1"></i> Cancelled By:</td>
                                        ...
                                        <div class="col-md-6">
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                                    <div class="fw-semibold"><i class="fa fa-check-circle me-1"></i> Total Paid:</div>
                                                    <span class="fs-5 text-success">{{ currency($sales['paid']) }}</span>
                                                </li>
                                                <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                                    <div class="fw-semibold"><i class="fa fa-exclamation-circle me-1"></i> Balance:</div>
                                                ...
                                                <li class="list-group-item px-0">
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            ...
                                                            <i class="fa fa-whatsapp me-1"></i> Send Invoice To WhatsApp
                                                        </label>
                                                    </div>
                                                </li>
                                            </ul>
                                            ...
                                            <div class="d-flex justify-content-end gap-2 mt-4">
                                                ...
                                                @else
                                                    <button type="submit" wire:confirm="Are you sure to update this?" class="btn btn-warning">
                                                        <i class="fa fa-refresh me-1"></i><i class="fa fa-print"></i> Update & Print
                                                    </button>
                                                @endif
                                            </div>
                                        </div>
