<div>
    <div class="modal-header d-flex justify-content-between align-items-center bg-light">
        <h1 class="modal-title fs-5 mb-0">
            <i class="demo-psi-inbox-full fs-4 me-2"></i>Sale Import
        </h1>
        <div>
    ...
    <form wire:submit="save">
        <div class="modal-body">
            ...
            <div class="mt-4">
                ...
                <div class="progress" style="height: 15px">
                    <div class="progress-bar progress-bar-striped progress-bar-animated bg-success" id="sale-progress-bar" role="progressbar" style="width: 0%" aria-valuenow="0" aria-valuemin="0"
        ...
        <div class="modal-footer bg-light">
            ...
            <button type="submit" class="btn btn-success" @if (!$file) disabled @endif>
                <i class="demo-psi-file-import me-1"></i> Import Sales
            </button>
        </div>
    </form>
    ...
    @push('scripts')
        ...
        <script>
            ...
            channel.bind('file-import-event-{{ auth()->id() }}', function(data) {
                console.log(data);
                if (data.type === 'Sale') {
                    const progressBar = document.getElementById('sale-progress-bar');
                    progressBar.style.width = `${data.progress}%`;
                    progressBar.setAttribute('aria-valuenow', data.progress);
                    $('#sale-progress-bar').text(Math.round(data.progress, 2));
