                ...
                <div class="row mb-2">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {{ html()->number('unit_price')->value('')->class('form-control number select_on_focus')->attribute('wire:model.lazy', 'item.unit_price') }}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <b><label for="quantity" class="text-capitalize text-end">quantity</label></b>
                            {{ html()->number('quantity')->value('')->class('form-control number select_on_focus')->attribute('wire:model.lazy', 'item.quantity')->attribute('step', 'any') }}
                        </div>
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {{ html()->number('discount')->value('')->class('form-control number select_on_focus')->attribute('step', 'any')->attribute('wire:model.lazy', 'item.discount') }}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <b><label for="tax" class="text-capitalize text-end">tax %</label></b>
                            {{ html()->number('tax')->value('')->attribute('max', '50')->class('form-control number select_on_focus')->attribute('style', 'width:100%')->attribute('wire:model.lazy', 'item.tax') }}
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {{ html()->number('total')->value('')->class('form-control number')->disabled(true)->attribute('wire:model.lazy', 'item.total') }}
                        </div>
                    </div>
                </div>
            @endif
