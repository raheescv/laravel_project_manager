<div>
    <div class="card-header bg-white">
        ...
        <a href="{{ route('sale::create_booking') }}"
           class="btn btn-sm btn-outline-success"
           title="Create Booking">
            <i class="demo-pli-add me-1"></i> Create Booking
        </a>
    @endcan
                </div>
            </div>
                ...
                <tbody>
                    @foreach ($data as $item)
                        <tr>
                            ...
                            @endif
                            <td class="text-nowrap">
                                <a href="{{ route('sale::view_booking', $item->id) }}" class="text-primary fw-semibold text-decoration-none">
                                    {{ $item->invoice_no }}
                                </a>
                            </td>
                            @if ($sale_visible_column['reference_no'])
