<div>
    <div class="card shadow-sm">
        <div class="card-header bg-light py-3">
            <div class="row mt-3">
                <div class="col-md-6 d-flex flex-wrap gap-2 align-items-center mb-3 mb-md-0">
                    @can('complaint category.create')
                        <button class="btn btn-primary d-flex align-items-center shadow-sm" id="ComplaintCategoryAdd">
                            <i class="fa fa-plus-circle me-2"></i>
                            Add New Category
                        </button>
                    @endcan
                    <div class="btn-group shadow-sm">
                        @can('complaint category.delete')
                    ...
                    <div class="row g-2 align-items-center">
                        ...
                        <div class="col">
                            <div class="input-group input-group-sm">
                                ...
                                <input type="text" wire:model.live="search" autofocus placeholder="Search complaint categories..." class="form-control form-control-sm border-secondary-subtle shadow-sm"
                                    autocomplete="off">
                            </div>
                        </div>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="fw-medium text-dark">
                                        <i class="fa fa-folder-o me-1 text-primary opacity-75"></i>{{ $item->name }}
                                    </span>
                                </td>
                                <td>
                                    @if($item->arabic_name)
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center py-5 text-muted">
                                    <i class="fa fa-folder-o fa-3x mb-3 d-block opacity-25"></i>
        ...
        <div class="position-fixed bottom-0 end-0 mb-4 me-4 d-md-none">
            <button id="ComplaintCategoryAddMobile" class="btn btn-primary rounded-circle shadow btn-lg">
            ...
            <script>
                $(document).ready(function() {
                    ...
                    $(document).on('click', '.edit', function() {
                        Livewire.dispatch("ComplaintCategory-Page-Update-Component", {
                            id: $(this).attr('table_id')
                        });
                    });
                    $('#ComplaintCategoryAdd, #ComplaintCategoryAddMobile').click(function() {
                        Livewire.dispatch("ComplaintCategory-Page-Create-Component");
                    });
                    window.addEventListener('RefreshComplaintCategoryTable', event => {
                        Livewire.dispatch("ComplaintCategory-Refresh-Component");
                    });
                });
            </script>
        @endpush
