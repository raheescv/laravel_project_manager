<div>
    <div class="modal-header border-bottom-0 pb-0">
        <h5 class="modal-title fw-bold">
            ...
            {{ isset($formData['id']) ? 'Edit Complaint Category' : 'Create New Complaint Category' }}
        </h5>
            ...
            <div class="row g-4">
                <div class="col-md-12">
                    <div class="form-floating">
                        <input type="text" class="form-control @error('formData.name') is-invalid @enderror" id="name" placeholder="Category Name" required wire:model="formData.name">
