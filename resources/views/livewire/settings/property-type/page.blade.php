<div>
    <div class="modal-header border-bottom-0 pb-0">
        <h5 class="modal-title fw-bold">
            ...
            {{ isset($formData['id']) ? 'Edit Property Type' : 'Create New Property Type' }}
        </h5>
            ...
            <div class="row g-4">
                <div class="col-md-12">
                    <div class="form-floating">
                        <input type="text" class="form-control @error('formData.name') is-invalid @enderror" id="name" placeholder="Property Type Name" required wire:model="formData.name">
