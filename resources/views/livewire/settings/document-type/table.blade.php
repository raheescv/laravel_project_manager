            ...
            <div class="row mt-3">
                <div class="col-md-6 d-flex flex-wrap gap-2 align-items-center mb-3 mb-md-0">
                    @can('document type.create')
                        <button class="btn btn-primary d-flex align-items-center shadow-sm" id="DocumentTypeAdd">
                    ...
                    <div class="row g-2 align-items-center">
                        ...
                        <div class="col">
                            <div class="input-group input-group-sm">
                                ...
                                <input type="text" wire:model.live="search" autofocus placeholder="Search document types..." class="form-control form-control-sm border-secondary-subtle shadow-sm"
                                    autocomplete="off">
                            </div>
                        </div>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="fw-medium text-dark">
                                        <i class="fa fa-file-text-o me-1 text-primary opacity-75"></i>{{ $item->name }}
                                    </span>
                                </td>
                                <td>
                                    @if($item->arabic_name)
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center py-5 text-muted">
                                    <i class="fa fa-file-text-o fa-3x mb-3 d-block opacity-25"></i>
