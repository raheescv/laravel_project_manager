<div>
    <div class="modal-header border-bottom-0 pb-0">
        <h5 class="modal-title fw-bold">
            ...
            {{ isset($formData['id']) ? 'Edit Utility' : 'Create New Utility' }}
        </h5>
            ...
            <div class="row g-4">
                <div class="col-md-12">
                    <div class="form-floating">
                        <input type="text" class="form-control @error('formData.name') is-invalid @enderror" id="utility_name" placeholder="Utility Name" required wire:model="formData.name">
                        <label for="utility_name">Name</label>
                        @error('formData.name')
