        ...
        <script>
            $(document).ready(function() {
                $(document).on('click', '.edit', function() {
                    Livewire.dispatch("Department-Page-Update-Component", {
                        id: $(this).attr('table_id')
                    });
                });
                $('#DepartmentAdd').click(function() {
                    Livewire.dispatch("Department-Page-Create-Component");
                });
                window.addEventListener('RefreshDepartmentTable', event => {
                    Livewire.dispatch("Department-Refresh-Component");
                });
            });
        </script>
    @endpush
