<div>
    <div class="modal-header">
        <h1 class="modal-title fs-5" id="DepartmentModalLabel">Department Modal</h1>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        {{ html()->input('name')->value('')->class('form-control')->required(true)->attribute('wire:model', 'departments.name') }}
                    </div>
                </div>
            </div>
        </div>
