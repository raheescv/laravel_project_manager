<div>
    <div class="modal-header border-bottom-0 pb-0">
        <h5 class="modal-title fw-bold" id="tailoringMeasurementOptionModalLabel">
            <i class="fa fa-pencil-square-o fs-4 me-2 text-primary"></i>
            ...
            <div class="row g-4">
                <div class="col-12">
                    <div class="form-floating">
                        <input type="text" class="form-control @error('options.option_type') is-invalid @enderror" id="options_option_type" placeholder="e.g. collar_designs, cuff_designs" required
                            wire:model="options.option_type">
