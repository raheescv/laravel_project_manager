        ...
        <div class="row g-3 align-items-center">
            <div class="col-12 col-md-6 d-flex gap-2">
                @can('designation.create')
                    <button class="btn btn-primary d-inline-flex align-items-center gap-2" id="DesignationAdd">
            ...
            <div class="col-12 col-md-6">
                <div class="d-flex flex-wrap gap-2 justify-content-md-end">
                    ...
                    <div class="d-flex bg-light rounded-2 px-2 flex-grow-1 flex-md-grow-0" style="min-width: 250px;">
                        ...
                        <input type="text" wire:model.live="search" autofocus placeholder="Search designations..." class="form-control bg-transparent border-0 py-2" style="box-shadow: none; font-size: 0.875rem;" autocomplete="off">
                    </div>
                </div>
            </div>
        </div>
        ...
        <script>
            $(document).ready(function() {
                $(document).on('click', '.edit', function() {
                    Livewire.dispatch("Designation-Page-Update-Component", {
                        id: $(this).attr('table_id')
                    });
                });
                $('#DesignationAdd').click(function() {
                    Livewire.dispatch("Designation-Page-Create-Component");
                });
                window.addEventListener('RefreshDesignationTable', event => {
                    Livewire.dispatch("RefreshDesignationTable");
                });
            });
        </script>
    @endpush
