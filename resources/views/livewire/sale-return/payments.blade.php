            ...
            <table class="table table-striped align-middle table-sm table-bordered">
                <thead>
                    <tr>
                        ...
                        <th class="text-end"> <x-sortable-header :direction="$sortDirection" :sortField="$sortField" field="sale_returns.total" label="total" /> </th>
                        <th class="text-end"> <x-sortable-header :direction="$sortDirection" :sortField="$sortField" field="sale_returns.paid" label="paid" /> </th>
                        <th class="text-end"> <x-sortable-header :direction="$sortDirection" :sortField="$sortField" field="sale_returns.balance" label="balance" /> </th>
                    </tr>
                </thead>
                <tbody>
