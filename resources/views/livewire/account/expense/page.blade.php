<div>
    <div class="modal-header">
        <h1 class="modal-title fs-5">Expense</h1>
    ...
    <form wire:submit="save">
        <div class="modal-body">
            ...
            <div class="row mb-3">
                <div class="col-md-4" wire:ignore>
                    <div class="form-group">
                        <b><label for="debit" class="text-capitalize">Expense Category *</label></b>
                ...
                <div class="col-md-4" wire:ignore>
                    <div class="form-group">
                        <b><label for="credit" class="text-capitalize">Payment Method *</label></b>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <b><label for="person_name" class="text-capitalize">Payee</label></b>
