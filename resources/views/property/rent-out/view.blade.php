        ...
        <div class="content__wrap">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">View {{ $config->singularLabel }}</li>
                </ol>
            </nav>
            <h1 class="page-title mb-0 mt-2">View {{ $config->singularLabel }}</h1>
            <p class="lead">
                {{ $config->singularLabel }} details and information
            </p>
        </div>
    </div>
