            ...
            <div class="space-y-4">
                <div class="grid grid-cols-2 gap-4">
                    <div class="form-group">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Thob Model</label>
                        <div class="flex gap-2">
                            <select 
                                v-model="measurements.thob_model"
                                class="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            >
                                <option value="">Select Model</option>
                                <option v-for="model in categoryModels" :key="model.id" :value="model.name">
                                    {{ model.name }}
                                </option>
                            </select>
                            <button 
                                type="button"
                                @click="addOption('thob_model')"
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="form-group">
                        ...
                        <input 
                            v-model.number="measurements.shoulder"
                            type="number"
                            step="0.01"
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            v-model.number="measurements.sleeve"
                            type="number"
                            step="0.01"
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="form-group">
                        ...
                        <input 
                            v-model.number="measurements.sl_chest"
                            type="number"
                            step="0.01"
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            v-model.number="measurements.sl_so"
                            type="number"
                            step="0.01"
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="form-group">
                        ...
                        <input 
                            v-model="measurements.mar_size"
                            type="text"
                            placeholder="Enter mar size..."
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        />
                    </div>
                    <div class="form-group">
                        ...
                        <div class="flex gap-2">
                            <select 
                                v-model="measurements.mar_model"
                                class="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            >
                                <option value="">Select Model</option>
                                <option v-for="option in getOptions('mar_model')" :key="option.id" :value="option.value">
                                    {{ option.value }}
                                </option>
                            </select>
                            <button 
                                type="button"
                                @click="addOption('mar_model')"
                                class="px-3 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 font-bold"
                            >
                                +
                            </button>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            v-model="measurements.cuff_size"
                            type="text"
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="form-group">
                        ...
                        <div class="flex gap-2">
                            <select 
                                v-model="measurements.cuff_cloth"
                                class="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            >
                                <option value="">Select Cloth</option>
                                <option v-for="option in getOptions('cuff_cloth')" :key="option.id" :value="option.value">
                                    {{ option.value }}
                                </option>
                            </select>
                            <button 
                                type="button"
                                @click="addOption('cuff_cloth')"
                                class="px-3 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 font-bold"
                            >
                                +
                            </button>
                    ...
                    <div class="form-group">
                        ...
                        <div class="flex gap-2">
                            <select 
                                v-model="measurements.cuff_model"
                                class="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            >
                                <option value="">Select Model</option>
                                <option v-for="option in getOptions('cuff_model')" :key="option.id" :value="option.value">
                                    {{ option.value }}
                                </option>
                            </select>
                            <button 
                                type="button"
                                @click="addOption('cuff_model')"
                                class="px-3 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 font-bold"
                            >
                                +
                            </button>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="form-group">
                        ...
                        <input 
                            v-model="measurements.neck_d_button"
                            type="text"
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            v-model="measurements.side_pt_size"
                            type="text"
            ...
            <div class="space-y-4">
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            v-model="measurements.collar_size"
                            type="text"
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="form-group">
                        ...
                        <div class="flex gap-2">
                            <select 
                                v-model="measurements.collar_cloth"
                                class="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            >
                                <option value="">Select Cloth</option>
                                <option v-for="option in getOptions('collar_cloth')" :key="option.id" :value="option.value">
                                    {{ option.value }}
                                </option>
                            </select>
                            <button 
                                type="button"
                                @click="addOption('collar_cloth')"
                                class="px-3 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 font-bold"
                            >
                                +
                            </button>
                    ...
                    <div class="form-group">
                        ...
                        <div class="flex gap-2">
                            <select 
                                v-model="measurements.collar_model"
                                class="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            >
                                <option value="">Select Model</option>
                                <option v-for="option in getOptions('collar_model')" :key="option.id" :value="option.value">
                                    {{ option.value }}
                                </option>
                            </select>
                            <button 
                                type="button"
                                @click="addOption('collar_model')"
                                class="px-3 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 font-bold"
                            >
                                +
                            </button>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="form-group">
                        ...
                        <input 
                            v-model="measurements.regal_size"
                            type="text"
                            placeholder="Enter regal size..."
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        />
                    </div>
                    <div class="form-group">
                        ...
                        <input 
                            v-model="measurements.knee_loose"
                            type="text"
                            placeholder="Enter knee loose..."
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        />
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="form-group">
                        ...
                        <input 
                            v-model="measurements.fp_down"
                            type="text"
                            placeholder="Enter FP down..."
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        />
                    </div>
                    <div class="form-group">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="form-group">
                        ...
                        <input 
                            v-model="measurements.fp_size"
                            type="text"
                            placeholder="Enter FP size..."
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        />
                    </div>
                    <div class="form-group">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="form-group">
                        ...
                        <div class="flex gap-2">
                            <select 
                                v-model="measurements.side_pt_model"
                                class="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            >
                                <option value="">Select Model</option>
                                <option v-for="option in getOptions('side_pt_model')" :key="option.id" :value="option.value">
                                    {{ option.value }}
                                </option>
                            </select>
                            <button 
                                type="button"
                                @click="addOption('side_pt_model')"
                                class="px-3 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 font-bold"
                            >
                                +
                            </button>
                    ...
                    <div class="form-group">
                        ...
                        <div class="flex gap-2">
                            <select 
                                v-model="measurements.stitching"
                                class="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            >
                                <option value="">Select Stitching</option>
                                <option v-for="option in getOptions('stitching')" :key="option.id" :value="option.value">
                                    {{ option.value }}
                                </option>
                            </select>
                            <button 
                                type="button"
                                @click="addOption('stitching')"
                                class="px-3 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 font-bold"
                            >
                                +
                            </button>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            v-model="measurements.button_no"
                            type="text"
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="form-group">
                        ...
                        <select 
                            v-model="measurements.mobile_pocket"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        >
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            v-model="measurements.tailoring_notes"
                            type="text"
