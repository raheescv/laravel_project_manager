...
class ConfigurationSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Configuration::updateOrCreate(['tenant_id' => 1, 'key' => 'sale_item_row_mode'], ['value' => 'separate']);
        Configuration::updateOrCreate(['tenant_id' => 1, 'key' => 'prevent_out_of_stock_sales'], ['value' => 'no']);
        Configuration::updateOrCreate(['tenant_id' => 1, 'key' => 'hide_out_of_stock_sale_items'], ['value' => 'no']);
        ...
        Configuration::updateOrCreate(['tenant_id' => 1, 'key' => 'active_module'], ['value' => 'POS Module']);
        $saleVisibleColumns = [
            'created_at' => false,
            'reference_no' => false,
            'branch_id' => false,
