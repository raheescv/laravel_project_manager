...
class AccountSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $data[] = ['name' => 'Unbilled Payables', 'slug' => 'unbilled_payables', 'account_type' => 'liability', 'description' => 'Temporary clearing account between GRN receipt and purchase invoice posting', 'model' => null, 'second_reference_no' => null, 'account_category_id' => $currentLiabilityMaster->id];
