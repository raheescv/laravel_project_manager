...
class CountrySeeder extends Seeder
{
    public function run(): void
    {
        ...
        $data = [
            ...
            ['name' => 'Anguilla', 'code' => 'AI', 'phone_code' => '1264'],
            ['name' => 'Aland Islands', 'code' => 'AX', 'phone_code' => '358'],
            ...
            ['name' => 'American Samoa', 'code' => 'AS', 'phone_code' => '1684'],
            ['name' => 'Antarctica', 'code' => 'AQ', 'phone_code' => '672'],
            ['name' => 'French Southern Territories', 'code' => 'TF', 'phone_code' => '262'],
            ...
            ['name' => 'Bonaire, Sint Eustatius and Saba', 'code' => 'BQ', 'phone_code' => '599'],
            ...
            ['name' => 'Cook Islands', 'code' => 'CK', 'phone_code' => '682'],
            ...
            ['name' => 'Falkland Islands (Malvinas)', 'code' => 'FK', 'phone_code' => '500'],
            ['name' => 'France', 'code' => 'FR', 'phone_code' => '33'],
            ['name' => 'Faroe Islands', 'code' => 'FO', 'phone_code' => '298'],
            ['name' => 'Micronesia, Federated States of', 'code' => 'FM', 'phone_code' => '691'],
            ...
            ['name' => 'Guam', 'code' => 'GU', 'phone_code' => '1671'],
            ['name' => 'Guyana', 'code' => 'GY', 'phone_code' => '592'],
            ['name' => 'Hong Kong', 'code' => 'HK', 'phone_code' => '852'],
            ['name' => 'Heard Island and McDonald Islands', 'code' => 'HM', 'phone_code' => '672'],
            ...
            ['name' => 'India', 'code' => 'IN', 'phone_code' => '91', 'currency_code' => 'RS', 'currency_symbol' => '₹'],
            ['name' => 'British Indian Ocean Territory', 'code' => 'IO', 'phone_code' => '246'],
            ['name' => 'Ireland', 'code' => 'IE', 'phone_code' => '353'],
            ['name' => 'Iran, Islamic Republic of', 'code' => 'IR', 'phone_code' => '98'],
            ...
            ['name' => 'Saint Kitts and Nevis', 'code' => 'KN', 'phone_code' => '1869'],
            ['name' => 'Korea, Republic of', 'code' => 'KR', 'phone_code' => '82'],
            ['name' => 'Kuwait', 'code' => 'KW', 'phone_code' => '965'],
            ['name' => "Lao People's Democratic Republic", 'code' => 'LA', 'phone_code' => '856'],
            ['name' => 'Lebanon', 'code' => 'LB', 'phone_code' => '961'],
            ['name' => 'Liberia', 'code' => 'LR', 'phone_code' => '231'],
            ['name' => 'Libya', 'code' => 'LY', 'phone_code' => '218'],
            ['name' => 'Saint Lucia', 'code' => 'LC', 'phone_code' => '1758'],
            ...
            ['name' => 'Saint Martin (French part)', 'code' => 'MF', 'phone_code' => '590'],
            ['name' => 'Morocco', 'code' => 'MA', 'phone_code' => '212'],
            ['name' => 'Monaco', 'code' => 'MC', 'phone_code' => '377'],
            ['name' => 'Moldova, Republic of', 'code' => 'MD', 'phone_code' => '373'],
            ...
            ['name' => 'Northern Mariana Islands', 'code' => 'MP', 'phone_code' => '1670'],
            ['name' => 'Mozambique', 'code' => 'MZ', 'phone_code' => '258'],
            ['name' => 'Mauritania', 'code' => 'MR', 'phone_code' => '222'],
            ['name' => 'Montserrat', 'code' => 'MS', 'phone_code' => '1664'],
            ...
            ['name' => 'Pitcairn', 'code' => 'PN', 'phone_code' => '64'],
            ...
            ['name' => 'Puerto Rico', 'code' => 'PR', 'phone_code' => '1787'],
            ['name' => "Korea, Democratic People's Republic of", 'code' => 'KP', 'phone_code' => '850'],
            ['name' => 'Portugal', 'code' => 'PT', 'phone_code' => '351'],
            ['name' => 'Paraguay', 'code' => 'PY', 'phone_code' => '595'],
            ['name' => 'Palestine, State of', 'code' => 'PS', 'phone_code' => '970'],
            ['name' => 'French Polynesia', 'code' => 'PF', 'phone_code' => '689'],
            ['name' => 'Qatar', 'code' => 'QA', 'phone_code' => '974', 'currency_code' => 'QAR', 'currency_symbol' => 'ر.ق'],
            ['name' => 'Réunion', 'code' => 'RE', 'phone_code' => '262'],
            ['name' => 'Romania', 'code' => 'RO', 'phone_code' => '40'],
            ['name' => 'Russian Federation', 'code' => 'RU', 'phone_code' => '7'],
            ...
            ['name' => 'South Georgia and the South Sandwich Islands', 'code' => 'GS', 'phone_code' => '500'],
            ['name' => 'Saint Helena, Ascension and Tristan da Cunha', 'code' => 'SH', 'phone_code' => '290'],
            ['name' => 'Svalbard and Jan Mayen', 'code' => 'SJ', 'phone_code' => '47'],
            ...
            ['name' => 'Saint Pierre and Miquelon', 'code' => 'PM', 'phone_code' => '508'],
            ...
            ['name' => 'Sint Maarten (Dutch part)', 'code' => 'SX', 'phone_code' => '1721'],
            ['name' => 'Seychelles', 'code' => 'SC', 'phone_code' => '248'],
            ['name' => 'Syrian Arab Republic', 'code' => 'SY', 'phone_code' => '963'],
            ['name' => 'Turks and Caicos Islands', 'code' => 'TC', 'phone_code' => '1649'],
            ...
            ['name' => 'Taiwan, Province of China', 'code' => 'TW', 'phone_code' => '886'],
            ['name' => 'Tanzania, United Republic of', 'code' => 'TZ', 'phone_code' => '255'],
            ['name' => 'Uganda', 'code' => 'UG', 'phone_code' => '256'],
            ['name' => 'Ukraine', 'code' => 'UA', 'phone_code' => '380'],
            ['name' => 'United States Minor Outlying Islands', 'code' => 'UM', 'phone_code' => '1'],
            ['name' => 'Uruguay', 'code' => 'UY', 'phone_code' => '598'],
            ['name' => 'United States', 'code' => 'US', 'phone_code' => '1'],
            ['name' => 'Uzbekistan', 'code' => 'UZ', 'phone_code' => '998'],
            ['name' => 'Holy See (Vatican City State)', 'code' => 'VA', 'phone_code' => '379'],
            ['name' => 'Saint Vincent and the Grenadines', 'code' => 'VC', 'phone_code' => '1784'],
            ['name' => 'Venezuela, Bolivarian Republic of', 'code' => 'VE', 'phone_code' => '58'],
            ['name' => 'Virgin Islands, British', 'code' => 'VG', 'phone_code' => '1284'],
            ['name' => 'Virgin Islands, U.S.', 'code' => 'VI', 'phone_code' => '1340'],
            ['name' => 'Viet Nam', 'code' => 'VN', 'phone_code' => '84'],
