    ...
    public function up()
    {
        ...
        DB::unprepared('
            CREATE PROCEDURE getNextUniqueNumber(
                ...
                IN in_branch_code VARCHAR(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
            ...
            BEGIN
                ...
                VALUES (in_tenant_id, in_year, in_branch_code, in_segment, 1)
                ...
                AND year = in_year
                AND branch_code = in_branch_code
